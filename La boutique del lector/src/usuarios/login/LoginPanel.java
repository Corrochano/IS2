...
public class LoginPanel extends JPanel implements ActionListener{
	...
	private static final long serialVersionUID = 1L;
		...
		/**
		 * Inicializa la GUI del usuario
		 * @param rol rol del usuario, puede ser administrador on cliente.
		 */
		public void openView(String rol) {
			new UsuarioGUI(rol, user_dni);
		}

		/**
		 * Muestra un mensaje de error por pantalla.
		 * @param msg El mensaje de error al mostrar.
		 */
