...
public class ClienteAltaPanel extends JPanel implements ActionListener{
		...
		if(txt.equals("enviar")){
			if(!hayCampoVacio()){
				...
				try {
					...
					showErrorMsg("Usuario ya existente");
				}
				vaciarCampos();
	...
	/**
	 * Inicializa los textfield para que no tengan texto.
	 */
